...
with open(INPUT_FILE, "r") as file:
    for line in file:
        ...
        # move crates
            ...
            num_moved, from_stack, to_stack = int(num_moved), int(from_stack), int(to_stack)
            
            # split the from_stack & update
            to_be_moved, stacks[from_stack] = stacks[from_stack][-num_moved:], stacks[from_stack][:-num_moved]
            # extend to_stack
